...
class MPNN(nn.Module):
    ...
    def __init__(self, adj_mx, n_in, msg_hid, msg_out, n_hid, n_out, dropout_prob):
        ...
        self.msg_fc1 = nn.ModuleList(
            [nn.Linear(in_features=n_in * 2, out_features=msg_hid) for _ in range(self.edge_types)]
        )
    ...
    def forward(self, x):
        ...
        # Output MLP
        pred = F.dropout(F.relu(self.out_fc1(aug_msgs)), p=self.dropout_prob, training=self.training)
