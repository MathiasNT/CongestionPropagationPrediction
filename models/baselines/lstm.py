...
class RnnModelBase(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        #self.log(f'train/bce_loss', bce_loss, on_step=False, on_epoch=True)
        #self.log(f'train/start_loss', start_loss, on_step=False, on_epoch=True)
        #self.log(f'train/end_loss', end_loss, on_step=False, on_epoch=True)
        #self.log(f'train/speed_loss', speed_loss, on_step=False, on_epoch=True)
        #self.log(f'train/accuracy', accuracy, on_step=False, on_epoch=True)
        #self.log(f'train/precision', precision, on_step=False, on_epoch=True)
        #self.log(f'train/recall', recall, on_step=False, on_epoch=True)
        return loss
...
class RnnInformedModel(RnnModelBase):
...
class RnnNetworkInformedModel(RnnModelBase):
    """Informed RNN baseline.
...
class ExtendedRnnNetworkInformedModel(RnnModelBase):
    """Informed RNN baseline.
